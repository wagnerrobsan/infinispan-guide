...
public class ProgrammaticNamedCacheConfigurationTest extends BaseTest{
	...
	public void testProgrammaticNamedCacheConfiguration() {
		Configuration c = new ConfigurationBuilder().jmxStatistics().enable()
				.build();
	...
	public void testProgrammaticClusterLoaderConfiguration() {
		Configuration c = new ConfigurationBuilder().persistence().addClusterLoader().addProperty("remoteCallTimeout", "20000").build();
