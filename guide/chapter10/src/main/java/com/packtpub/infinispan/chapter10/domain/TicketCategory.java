...
public class TicketCategory implements Serializable {
   ...
   * 
   * <p>
   * The description must not be null and must be one or more characters, the Bean Validation
   * constrain <code>@NotEmpty</code> enforces this.
   * </p>
   * 
   */
  @Column(unique = true)
  ...
  /*
   * toString(), equals() and hashCode() for TicketCategory, using the natural identity of the
   * object
   */
