...
public class Venue implements Serializable {
   ...
   * 
   * <p>
   * The name must not be null and must be one or more characters, the Bean Validation constrain
   * <code>@NotEmpty</code> enforces this.
   * </p>
   */
  @Column(unique = true)
  @NotNull
   ...
   * attribute establishes this. We cascade all persistence operations to the set of performances,
   * so, for example if a venue is removed, then all of it's sections will also be removed.
   * </p>
   */
